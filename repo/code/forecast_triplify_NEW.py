...
def main():
    ...
    research2forecast(research_forecast_list, './output/research2forecast.ttl')


if __name__ == "__main__":
    main()
    main_model_assumption_method()
    main_places()
    main_groundTruth()
