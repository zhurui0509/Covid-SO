...
def main():
    ...
    # column_list_state = ['year','month','day','statefips','spend_acf','spend_aer','spend_all','spend_apg','spend_grf','spend_hcs',
    # 'spend_tws','spend_all_inchigh','spend_all_inclow','spend_all_incmiddle']
    # column_list_national = ['year', 'month', 'day spend_acf', 'spend_aer', 'spend_all', 'spend_apg', 'spend_grf', 'spend_hcs', 
    # 'spend_tws', 'spend_all_inchigh', 'spend_all_inclow', 'spend_all_incmiddle']
